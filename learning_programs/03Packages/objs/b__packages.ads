...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_packages" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#eda20913#;
   pragma Export (C, u00001, "packagesB");
   ...
   u00116 : constant Version_32 := 16#4ffc39d1#;
   pragma Export (C, u00116, "weekB");
   u00117 : constant Version_32 := 16#c7a5dcd6#;
   pragma Export (C, u00117, "weekS");
